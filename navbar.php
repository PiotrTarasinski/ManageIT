...
function display_navbar(){
    ...
    $db = new db();
    //sql query
    $sql = "SELECT * FROM messages WHERE recipient_id='".$_SESSION['user_id']."'";
    $messages_count = 0;
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="#" id="open_messages"><i class="fas fa-envelope"></i> Wiadomości <span class="badge badge-primary">'.$messages_count.'</span></a>
